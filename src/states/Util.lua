...
--[[
	...
	width and a height for the titles therein, split the textures into
...
--[[
	This function is specifically made to place out the paddles from the
...
function GenerateQuadsPaddles(atlas)
	...
	for i = 0, 3 do
		...
		counter = counter + 1
		-- medium
		quads[counter] = love.graphics.newQuad(x + 32, y + 64, 64, 16,
			altas:getDimensions())
		counter = counter + 1
		-- large
		quads[counter] = love.graphics.newQuad(x + 96, y + 96, 96, 16,
			altas:getDimensions())
		counter = counter + 1
		-- huge
		quads[counter] = love.graphics.newQuad(x, y + 16, 128, 16,
			altas:getDimensions())
		counter = counter + 1
		-- prepae X and Y for the next set of paddles
		x = 0 
		y = y + 32
	end
